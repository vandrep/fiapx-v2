...
1. **Evento terminal descartado quando chega fora de ordem.** `ExtracaoIniciada` e
   ...
   em `PROCESSANDO` para sempre, **com o `.zip` já no bucket** — 45 de 45 presos conferidos.
   Incidência: 11/400 (2,75%) sob pico com uma réplica reiniciada, **34/39** depois de o
