...
echo "    recusas ..: as 4xx que o cenario 'erro' gerou estao na linha Borda do painel (ticket 097);"
echo "                o 'Error Rate' do RED conta so 5xx, e segue vazio de proposito"
